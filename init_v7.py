...
retName_v2 = ['Probability_afraid','Probability_anger','Probability_bored','Probability_excited','Probability_happy', 'Probability_relax', 'Probability_sad', 'Probability_worry']
...
def predict(text):
    ...
    for model in [model[:-5]for model in os.listdir('C:/Users/Chempaka Seri/Documents/UM_EmotionClassification_API/Models')[1:]]:
